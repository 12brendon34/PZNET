...
#define FRAME_INCOMING_BUFFER_COUNT 100
    ...
    public:
        ...
        void Init(unsigned int speexSampleRate); //, unsigned bufferSizeBytes);
    ...
    protected:
        ...
        //lowkey IDK bout the struct, Might look to see if this is accurate, might not.
        /*
        DataStructures::OrderedList<RakNetGUID, VoiceChannel*, VoiceChannelComp> voiceChannels;
        float* bufferedOutput;
